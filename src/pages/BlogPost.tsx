...
const AUTHOR_BIOS: Record<string, string> = {
  '이지수': '인스타그램·유튜브 채널 운영 8년차 크리에이터. 플랫폼 알고리즘 분석과 콘텐츠 전략 수립을 전문으로 하며, 실전에서 검증한 소셜미디어 최적화 노하우를 공유합니다.',
  '박서현': '디지털 마케팅 에이전시 출신 콘텐츠 전략가. SEO와 CRO(전환율 최적화)를 결합한 콘텐츠 설계를 전문으로 하며, 기술적 SEO와 가독성을 동시에 잡는 방법을 연구합니다.',
  '김민혁': '10년차 SEO 전문가. 검색 엔진 알고리즘 분석과 EEAT 기반 콘텐츠 최적화를 전문으로 하며, 구글·네이버 양대 검색 생태계에서의 노출 극대화 전략을 다룹니다.',
};
